window.Actions = {
    ...
    scissor: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 10, attackModifier: 0.4,}
          ]
    },
    poisonBite: {
        name: "Poison Bite",
        ...
        success: [
            ...
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 5, attackModifier: 0.5,},
            { type: "textMessage", text: "Além do dano da mordida, Veneno causa 10% da vida de {TARGET}"},
    ...
    mobFire: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamage: 20, magicModifier: 0.70},
        ]
    },
    mobWater: {
        name: "Water",
        ...
        success: [
            ...
            { type: "stateChange", MagicDamage: 31, magicModifier: 0.80, },
        ]
    },
    ...
    lance: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 40, attackModifier: 0.7,}
          ]
    },
    chargeLance: {
        name: "Charge",
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damageX: 15, attackModifier: 0.5,}
          ]
    },
    blackShield: {
        name: "Black Shield",
        ...
        success: [
            { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
            { type: "stateChange", status: {type: "armor", expiresIn: 7, armor: 25}},
        ]
    },
    ...
    bloodHalberd: {
        ...
        success: [
            ...
            { type: "textMessage", text: "{CASTER} encanta sua Halberd com seu proprio sangue trocando 10% de sua vida por poder!"},
            { type: "stateChange", status: {type: "attackBoost", expiresIn: 7, attackBoost: 40, } },
          ]
    },
    ...
    scythe: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 60, attackModifier: 1.2,}
          ]
    },
    soulDestruction: {
        name: "Soul Reaper",
    ...
    magicBlessing: {
        ...
        success: [
            ...
            { type: "textMessage", text: "{CASTER} encanta seu Staff em troca de 15% da sua vida por poder"},
            { type: "stateChange", status: {type: "magicBoost", expiresIn: 7, magicAttackBoost: 80, } },
          ]
    },
    ...
    attackFullBoost: {
        ...
        success: [
          { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
          { type: "stateChange", status: {type: "attackFullBoost", expiresIn: 7, attackBoost: 15, magicAttackBoost: 10} },
        ]
      },
    // Felicia Boss Moves
    darknessHand: {
    ...
    cyrstalRain: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamageX: 50, magicModifier: 0.50},
          ]
    },
    cyrstalFelicia: {
        ...
        success: [
            ...
            { type: "textMessage", text: "{CASTER} congela 70% da vida de {TARGET} com {ACTION}!"},
          ]
    },
   ...
   ishtarDualBlade: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 50, attackModifier: 0.7, mpCost: 6},
            { type: "textMessage", text: "{CASTER} executa o segundo golpe de {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 32, attackModifier: 1.10,},
          ]
    },
    ...
    ishtarFireSword: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamage: 20, damage:31, attackModifier: 1.10, magicModifier: 0.70,mpCost: 10},
        ]
    },
    ...
    ishtarDanceofSword: {
        ...
        success: [
            ...
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 25, attackModifier: 0.5, mpCost: 30},
            { type: "textMessage", text: "{CASTER}: DEUX"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 30, attackModifier: 0.7, mpCost: 30},
            { type: "textMessage", text: "{CASTER}: TROIS"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 40, attackModifier: 1.9, mpCost: 30},
            { type: "textMessage", text: "{CASTER}: QUATRE"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 60, attackModifier: 1.1, mpCost: 30},
            { type: "textMessage", text: "{CASTER}: CINQ"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 82, attackModifier: 1.3, mpCost: 15},
            { type: "textMessage", text: "{CASTER}: SIX"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 91, attackModifier: 1.5, mpCost: 10},
            { type: "textMessage", text: "{CASTER}: SEPT"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 120, attackModifier: 2.0, mpCost: 5},
    ...
    blessHero: {
        name: "Hero Aura",
        description: "Aura da Heroina que recupera seu HP, Aumenta seu Ataque e sua Defesa",
        mpCost: 40,
        targetType: "friendly",    
        success: [
            { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
            { type: "stateChange", status: {type: "armor", expiresIn: 7, armor: 30, mpCost: 40}},
            { type: "stateChange", status: {type: "attackBoost", expiresIn: 7, attackBoost: 30, } },
    ...
    blessHero2: {
        name: "Hero Aura 2",
        description: "Aura da Heroina que recupera seu HP, Aumenta seu Ataque e sua Defesa drasticamente",
        mpCost: 70,
        targetType: "friendly",    
        success: [
            { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
            { type: "stateChange", status: {type: "armor", expiresIn: 7, armor: 75, mpCost: 70}},
            { type: "stateChange", status: {type: "attackBoost", expiresIn: 7, attackBoost: 75, } },
    ...
    freyaHeal: {
        ...
        success: [
            ...
            { type: "textMessage", text: "Todos os membros da equipe recuperaram um pouco de vida!"},
        ]
    },
    ...
    freyaHeal2: {
        ...
        success: [
            ...
            { type: "textMessage", text: "Todos os membros da equipe recuperaram vida!"},
        ]
    },
    ...
    celestiaDarkStaff: {
        name: "Dark Staff",
        description: "Embui o Cajado com um pouco de magia de Trevas e causa Dano Fisico e Magico ao alvo",
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", damage: 8, attackModifier: 0.45},
            { type: "animation", animation: "sleep"},
            { type: "stateChange", MagicDamage: 10, magicModifier: 0.40,}
          ]
    },
    ...
    celestiaSoulBreak: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", MagicDamage: 15, magicModifier: 0.6, mpCost: 15},
            { type: "textMessage", text: "{CASTER} destroi um pedaço da alma de {TARGET} causando 5% da vida de {TARGET}"},
            { type: "animation", animation: "sleep"},
    ...
    celestiaAbsorb: {
        name: "Absorb",
        description: "Causa dano Magico no inimigo e 50% do dano causado ao alvo é convertido em vida para Celestia",
        mpCost: 7,
        success: [
            { type: "textMessage", text: "{CASTER} uses {ACTION}!"},
            { type: "animation", animation: "drain"},
            { type: "stateChange", MagicDamage: 30, absorbPercent: 0.5, magicModifier: 0.7, mpCost: 7},
        ]
    },
    celestiaVampirism: {
        name: "Vampirism",
        ...
        success: [
            ...
            { type: "textMessage", text: "{CASTER} sacrificou 10% de HP por 50 de mana"},
        ]
    },
    ...
    celestiaIce: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamage: 22, magicModifier: 1.1,mpCost: 5},
        ]
    },
    ...
    celestiaBlizzard: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamageX: 22, magicModifier: 0.5, mpCost: 14},
        ]
    },
    ...
    celestiaShield: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} uses {ACTION}!"},
            { type: "stateChange", status: {type: "armor", expiresIn: 7, armor: 60, mpCost: 10}},
        ]
    },
    ...
    aerinMagicDagger: {
        ...
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "animation", animation: "spin"},
            { type: "stateChange", MagicDamage: 20, magicModifier: 1.1, mpCost: 3},
          ]
    },
    ...
    aerinBattleDance: {
        ...
        mpCost: 240,
        description: "Aerin dança com sua rapieira e adaga magica atacando 4 vezes com elementos diferentes, causando Dano Fisico e Magico MASSIVO",
        success: [
            { type: "textMessage", text: "{CASTER} ataca com {ACTION}!"},
            { type: "textMessage", text: "{CASTER}: Fogo!"},
            { type: "animation", animation: "spin"},
            { type: "animation", animation: "fireSword" },
            { type: "stateChange", MagicDamage: 20, damage:25, attackModifier: 0.9, magicModifier: 0.6,mpCost: 30},
            { type: "textMessage", text: "{CASTER}: Água!"},
            { type: "animation", animation: "spin"},
            { type: "animation", animation: "waterSword" },
            { type: "stateChange", MagicDamage: 30, damage:42, attackModifier: 1.1, magicModifier: 0.9,mpCost: 30},
            { type: "textMessage", text: "{CASTER}: Gelo!"},
            { type: "animation", animation: "spin"},
            { type: "animation", animation: "iceSword" },
            { type: "stateChange", MagicDamage: 45, damage:66, attackModifier: 1.3, magicModifier: 1.2,mpCost: 30},
            { type: "textMessage", text: "{CASTER}: Raio!"},
            { type: "animation", animation: "spin"},
            { type: "animation", animation: "boltSword" },
            { type: "stateChange", MagicDamage: 80, damage:99, attackModifier: 1.5, magicModifier: 1.5,mpCost: 30},
            { type: "textMessage", text: "{CASTER}: Sinta a alma dos elementos e uma linda dança!"},
          ]
    },
    aerinElfSecretBlessing: {
        ...
        success: [
          { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
          { type: "stateChange", status: {type: "attackFullBoost", expiresIn: 7, attackBoost: 25, magicAttackBoost: 15}, mpCost: 35 },
        ]
      },

      aerinElfSecretBlessing2: {
        name: "Elf Blessing 2",
        description: "Aumenta consideravelmente o ataque e o ataque mágico de Aerin",
        targetType: "friendly",
        mpCost: 50,
        success: [
          { type: "textMessage", text: "{CASTER} usa {ACTION}!"},
          { type: "stateChange", status: {type: "attackFullBoost", expiresIn: 7, attackBoost: 70, magicAttackBoost: 40}, mpCost: 50 },
        ]
      },
    ...
    aerinBolt: {
        ...
        success: [
            ...
            { type: "stateChange", MagicDamage: 28, magicModifier: 1.25,mpCost: 8},
        ]
    },
    // Items
    Potion1: {
    ...
    Potion2: {
        ...
        success: [
            ...
            { type: "textMessage", text: " Todos os membros da equipe recuperaram 200 de vida!"},
        ]
    },
    Potion3: {
        name: "Full Potion",
        ...
        success: [
            ...
            { type: "textMessage", text: " Todos os membros da equipe recuperaram 500 de vida!"},
        ]
    },
    Elixir1: {
        name: "Elixir",
        ...
        success: [
            ...
            { type: "textMessage", text: " Todos os membros da equipe recuperaram 50 de mana!"},
        ]
    },
    Elixir2: {
        name: "Great Elixir",
        ...
        success: [
            ...
            { type: "textMessage", text: " Todos os membros da equipe recuperaram 150 de mana!"},
        ]
    },
    Elixir3: {
        name: "Full Elixir",
        ...
        success: [
            ...
            { type: "textMessage", text: " Todos os membros da equipe recuperaram 350 de mana!"},
        ]
    },
}
