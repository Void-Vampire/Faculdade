        ...
        talking: [
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Se tiver duvidas com comandos ou coisas do tipo fale com a garota acima",
                faceHero: "npc1",
              },
            ],
          },
          {
            events: [
              {
                type: "textMessage",
                text: "Bem vindo ao Prologo de Queen of Swords, Essa é uma versão teste que contém pouco conteúdo, aproveite.",
                faceHero: "npc1",
              },
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "Obviamente voce percebeu que para se mover é o famoso AWSD ou Cima, Baixo, Direita, Esquerda, Para abrir a opção de menu ESC e isso é tudo por hora",
                faceHero: "npc2",
              },
            ],
          },
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "FREYA: Vamos terminar com isso logo Ishtar, já descansamos vamos seguir em frente",
                faceHero: "hero2",
              },
            ],
          },
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "CELESTIA: Espero que as informaçoes estejam corretas sobre esse culto maligno",
                faceHero: "hero3",
              },
            ],
          },
  ...
  Forest2: {
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "Logo acima de mim, nessa area mais verde tem encontro com um grupo de inimigos, fique a vontade para testar o modo de combate",
                faceHero: "npc1",
              },
            ],
          },
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "FREYA: Uma casinha no meio do nada, que suspeito",
                faceHero: "hero2",
              },
            ],
          },
        ...
        talking: [
          {
            events: [
              {
                type: "textMessage",
                text: "CELESTIA: Parece que as informaçoes eram corretas",
                faceHero: "hero3",
              },
            ],
          },
    ...
    encounterZones: {
      [utils.asGridCoord(4, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest3" }],
        },
      ],
      [utils.asGridCoord(3, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest1" }],
        },
      ],
      [utils.asGridCoord(2, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest2" }],
        },
      ],
      [utils.asGridCoord(5, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest4" }],
        },
      ],
      [utils.asGridCoord(6, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest5" }],
        },
      ],
      [utils.asGridCoord(7, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest6" }],
        },
      ],
      [utils.asGridCoord(1, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Forest7" }],
        },
      ],
      [utils.asGridCoord(1, 13)]: [
        {
          events: [{ type: "battle", enemyId: "Forest8" }],
        },
      ],
      [utils.asGridCoord(2, 13)]: [
        {
          events: [{ type: "battle", enemyId: "Forest9" }],
        },
      ],
      [utils.asGridCoord(3, 13)]: [
        {
          events: [{ type: "battle", enemyId: "Forest10" }],
        },
      ],
    },
  },
        ...
        talking: [
          ...
          },
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "ISHTAR: Um lugar protegido por demonios que interessante",
                faceHero: "npc1",
              },
          ...
          },
          {
            events: [
              {
                type: "textMessage",
                text: "Guardas: perdida Garota? hahaha!",
                faceHero: "npc1",
              },
              ...
              {
                type: "textMessage",
                text: "Reaper: Impossivel Demonios perderem para uma humana",
              },
            ],
          },
        ],
        ...
        talking: [
          {
            ...
            events: [{ type: "textMessage", text: "Morto", faceHero: "npc2" }],
          },
          {
            required: ["DEFEATEDGUARDIANS"],
            events: [
              {
                type: "textMessage",
                text: "ISHTAR: Nada de Interessante",
                faceHero: "npc2",
              },
        ...
        talking: [
          {
            ...
            events: [{ type: "textMessage", text: "Morto", faceHero: "npc3" }],
          },
          {
            required: ["DEFEATEDGUARDIANS"],
            events: [
              {
                type: "textMessage",
                text: "ISHTAR: Quanto tempo não vejo um Reaper",
                faceHero: "npc3",
              },
  ...
  Floor1: {
        ...
        talking: [
          ...
          },
          {
            events: [
              {
                type: "textMessage",
                text: "Guarda: Intrusos? O que diabos aqueles idiotas estão fazendo lá em cima!",
                faceHero: "npc1",
              },
        ...
        talking: [
          {
            ...
            events: [{ type: "textMessage", text: "Morto" }],
          },
          {
            events: [
              {
        ...
        talking: [
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Fim do Prologo! Obrigado por jogar Queen of Sword",
              },
            ],
          },
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Felicia: Os 4 Sinistrals Derrotados...",
              },
              {
                type: "textMessage",
                text: "Felicia: O que há de se esperar de idiotas que foram selados á 1000 Anos",
              },
              {
                type: "textMessage",
                text: "Felicia: Não pense que será tão facil me derrotar quanto eles, HAHAHAHA!",
              },
          ...
          },
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Felicia: DAOS acho que seus subordinados não são nada alem de fracos",
              },
          ...
          },
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Felicia: GADES? Bom não importa ele é apenas o mais fraco dos Sinistrals",
              },
              { who: "Felicia", type: "walk", direction: "up" },
              { who: "Felicia", type: "walk", direction: "up" },
              { who: "Felicia", type: "walk", direction: "down" },
              {
                type: "textMessage",
                text: "Felicia: Sua vez AMON, O Deus do Caos",
              },
          ...
          },
          {
            ...
            events: [
              {
                type: "textMessage",
                text: "Felicia: Que bando de idiotas, bom não importa o ritual já está completo",
              },
              ...
              {
                type: "textMessage",
                text: "Felicia: Destrua os GADES, O Deus da Destruição",
              },
    ...
    encounterZones: {
      [utils.asGridCoord(5, 17)]: [
        {
          events: [{ type: "battle", enemyId: "Floor5" }],
        },
      ],
      [utils.asGridCoord(6, 17)]: [
        {
          events: [{ type: "battle", enemyId: "Floor4" }],
        },
      ],
      [utils.asGridCoord(5, 16)]: [
        {
          events: [{ type: "battle", enemyId: "Floor3" }],
        },
      ],
      [utils.asGridCoord(4, 16)]: [
        {
          events: [{ type: "battle", enemyId: "Floor2" }],
        },
      ],
      [utils.asGridCoord(4, 15)]: [
        {
          events: [{ type: "battle", enemyId: "Floor1" }],
        },
      ],
      ...
      [utils.asGridCoord(23, 12)]: [
        {
          events: [{ type: "battle", enemyId: "Floor3" }],
        },
      ],
      [utils.asGridCoord(24, 12)]: [
        {
          events: [{ type: "battle", enemyId: "Floor4" }],
        },
      ],
